...
<tr>
    ...
    <td>
<a class="detailSelect" href="home.php?mod=studentGroup&facultyID=<?=$row_major["FacultyID"] ?>&departmentID=<?=$row_major["DepartmentID"] ?>&majorID=<?=$row_major["MajorID"] ?>"><img width="30px;" height="30px;" src="image/png/blog.png" /></a>
   </td>
</tr>
<? } ?>
</table>