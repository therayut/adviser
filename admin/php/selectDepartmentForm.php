...
<tr>
	<td>
    	<?=$row_department["DepartmentName"] ?>
    </td>
    <td>
		<a class="detailSelect" href="home.php?mod=major&facultyID=<?=$row_department["FacultyID"] ?>&departmentID=<?=$row_department["DepartmentID"] ?>"><img width="30px;" height="30px;" src="image/png/blog.png" /></a>
   </td>
</tr>
<? } ?>
</table>
