...
function insertFacultyFrom(FacultyID){
	$(function() {
		...
		$("#dialog-confirm").load("staff/php/insertFacultyForm.php");
}
...
function insertDepartmentFrom(FacultyID){
	$(function() {
		...
		$("#dialog-confirm").load("staff/php/insertDepartmentForm.php?FacultyID="+FacultyID);
}
...
function insertMajorFrom(DepartmentID){
	$(function() {
			...
			$("#dialog-confirm").load("staff/php/insertMajorForm.php?DepartmentID="+DepartmentID);
}
...
function insertStudentGroupFrom(MajorID){
	$(function() {
		...
		$("#dialog-confirm").load("staff/php/insertStudentGroupForm.php?MajorID="+MajorID);
}
...
function submitInsertFaculty(){
	$.post('staff/sql/insertFaculty.php',$('#idInsertFacultyForm').serialize(),function(response){
		if(response=="success"){
...
function submitInsertDepartment(){
	$.post('staff/sql/insertDepartment.php',$('#idInsertDepartmentForm').serialize(),function(response){
		if(response=="success"){
			alert("บันทึกเรียบร้อยแล้ว");
			window.location=window.location
		}
...
function submitInsertMajor(){
	$.post('staff/sql/insertMajor.php',$('#idInsertMajorForm').serialize(),function(response){
		if(response=="success"){
			alert("บันทึกเรียบร้อยแล้ว");
			window.location=window.location
		}
...
function submitInsertStudentGroup(){
	$.post('staff/sql/insertStudentGroup.php',$('#idInsertStudentGroupForm').serialize(),function(response){
		if(response=="success"){
			alert("บันทึกเรียบร้อยแล้ว");
			window.location=window.location
		}
	...
	$(function() {
				$( "#dialog-confirm" ).dialog({
				 ...
				 // height:140,
				  ...
				  buttons: {
					"ตกลง": function() {
					$.post("staff/sql/deleteFaculty.php",{"FacultyID":FacultyID},function(response){
						if(response == "success"){
	...
	$(function() {
				$( "#dialog-confirm" ).dialog({
				 ...
				 // height:140,
				  ...
				  buttons: {
					"ตกลง": function() {
						$.post("staff/sql/deleteDepartment.php",{"DepartmentID":DepartmentID},function(response){
						if(response == "success"){
							alert("ลบเรียบร้อยแล้ว");
	...
	$(function() {
				$( "#dialog-confirm" ).dialog({
				 ...
				 // height:140,
				  ...
				  buttons: {
					"ตกลง": function() {
						$.post("staff/sql/deleteMajor.php",{"MajorID":MajorID},function(response){
						if(response == "success"){
							alert("ลบเรียบร้อยแล้ว");
	...
	$(function() {
				$( "#dialog-confirm" ).dialog({
				 ...
				 // height:140,
				  ...
				  buttons: {
					"ตกลง": function() {
					$.post("staff/sql/deleteStudentGroup.php",{"GroupID":GroupID},function(response){
						if(response == "success"){
							alert("ลบเรียบร้อยแล้ว");
...
function deleteNew(newID){
	...
	$(function() {
			...
			$("#dialog-confirm").load("staff/php/editFacultyForm.php?FacultyID="+FacultyID);
	}
	...
	$(function() {
			...
			$("#dialog-confirm").load("staff/php/editDepartmentForm.php?DepartmentID="+DepartmentID);
	}
	...
	$(function() {
			...
			$("#dialog-confirm").load("staff/php/editMajorForm.php?MajorID="+MajorID);
	}
	...
	$(function() {
			...
			$("#dialog-confirm").load("staff/php/editStudentGroupForm.php?GroupID="+GroupID);
	}
...
function submitEditFaculty(){
	$.post('admin/sql/editFaculty.php',$('#idEditFacultyForm').serialize(),function(response){
...
function submitEditDepartment(){
	$.post('admin/sql/editDepartment.php',$('#idEditDepartmentForm').serialize(),function(response){
...
function submitEditMajor(){
	$.post('admin/sql/editMajor.php',$('#idEditMajorForm').serialize(),function(response){
...
function submitEditStudentGroup(){
	$.post('admin/sql/editStudentGroup.php',$('#idEditStudentGroupForm').serialize(),function(response){
		if(response=="success"){
			alert("แก้ไขเรียบร้อยแล้ว");
			window.location=window.location
		}
